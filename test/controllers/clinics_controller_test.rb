...
class ClinicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clinic" do
    assert_difference('Clinic.count') do
      post clinics_url, params: { clinic: { clinic_address: @clinic.clinic_address, clinic_email: @clinic.clinic_email, clinic_name: @clinic.clinic_name, clinic_phone: @clinic.clinic_phone } }
    end
  ...
  test "should update clinic" do
    patch clinic_url(@clinic), params: { clinic: { clinic_address: @clinic.clinic_address, clinic_email: @clinic.clinic_email, clinic_name: @clinic.clinic_name, clinic_phone: @clinic.clinic_phone } }
